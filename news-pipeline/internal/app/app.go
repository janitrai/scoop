...
func printUsage() {
	fmt.Fprintln(os.Stderr, "news-pipeline CLI")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Usage:")
	fmt.Fprintln(os.Stderr, "  news-pipeline <command> [flags]")
	fmt.Fprintln(os.Stderr, "")
	...
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Use \"news-pipeline <command> -h\" for command-specific flags.")
}
